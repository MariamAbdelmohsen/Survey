	...
	{#constructor sets stage by adding data to an instance of the object
		...
		{#show results
		   while ($row = mysqli_fetch_assoc($result))
		   {
				...
				$this->aQuestion[] = new Question(dbOut($row['QuestionID']),
				dbOut($row['Question']),dbOut($row['Description']),
				$this->TotalQuestions,dbOut($row['InputType']));
		   }
		}
...
echo '<div class="panel panel-success">';
      foreach($this->aQuestion as $question)
        ...
        echo '<div class="panel-heading"> ' . $question->Number.  '<br />
				 ' . $question->Text . '
